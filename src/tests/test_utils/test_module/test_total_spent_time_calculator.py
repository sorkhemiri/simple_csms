...
class TotalSpentTimeCalculatorTestCase:
    ...
    async def test_testcase_result():
        ...
        result = await total_spent_time_calculator(start_time=start_time, stop_time=stop_time)
    ...
    async def test_start_time_gt_stop_time():
        with pytest.raises(HTTPException):
            ...
            await total_spent_time_calculator(start_time=start_time, stop_time=stop_time)